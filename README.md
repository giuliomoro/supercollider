...
> *NOTE:* If you have an old prototype Bela board (from 2015) you'll need to [get a fresh SD card image](https://code.soundsoftware.ac.uk/projects/beaglert/wiki) since the Bela API changed a little.
